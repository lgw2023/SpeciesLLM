...
log "LOSS_WEIGHTS GEP=${GEP_LOSS_WEIGHT}, ZERO_PROB=${ZERO_PROB_LOSS_WEIGHT}, GEPC=${GEPC_LOSS_WEIGHT}, GEPC_ZERO_PROB=${GEPC_ZERO_PROB_LOSS_WEIGHT}"
log "EXPERIMENT AMP_DTYPE=${AMP_DTYPE}, STATIC_GENE_DTYPE=${STATIC_GENE_DTYPE}, GENE_EMBEDDING_MODALITIES=${GENE_EMBEDDING_MODALITIES}, GENE_EMBEDDING_SUFFIX=${GENE_EMBEDDING_SUFFIX:-<none>}, RUNTIME_ATTN_IMPLEMENTATION=${RUNTIME_ATTN_IMPLEMENTATION:-config}"
