...
is_allowed_cli_var() {
  case "$1" in
    ...
    GRAD_CLIP_HARD_RAW_NORM_LIMIT|MAX_TRAIN_STEPS|COMPILE|\
...
set_default GRAD_SKIP_RATIO 100.0
set_default GRAD_SKIP_MAX 100000000000.0
set_default GRAD_CLIP_MIN 0.5
set_default GRAD_CLIP_MAX 0.5
...
set_default GRAD_CLIP_HARD_RAW_NORM_LIMIT 100000000000.0
