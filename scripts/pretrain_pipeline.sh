...
HUBER_DELTA="${HUBER_DELTA:-5.0}"
GEP_LOSS_WEIGHT="${GEP_LOSS_WEIGHT:-1.0}"
ZERO_PROB_LOSS_WEIGHT="${ZERO_PROB_LOSS_WEIGHT:-1.0}"
GEPC_LOSS_WEIGHT="${GEPC_LOSS_WEIGHT:-0.1}"
GEPC_ZERO_PROB_LOSS_WEIGHT="${GEPC_ZERO_PROB_LOSS_WEIGHT:-0.1}"
...
write_launcher_script() {
  local script_path="$1"
  {
    ...
    print_export GEP_LOSS_WEIGHT "$GEP_LOSS_WEIGHT"
    print_export ZERO_PROB_LOSS_WEIGHT "$ZERO_PROB_LOSS_WEIGHT"
    print_export GEPC_LOSS_WEIGHT "$GEPC_LOSS_WEIGHT"
    print_export GEPC_ZERO_PROB_LOSS_WEIGHT "$GEPC_ZERO_PROB_LOSS_WEIGHT"
