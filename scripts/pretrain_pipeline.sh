...
GRAD_SKIP_RATIO="${GRAD_SKIP_RATIO:-100.0}"
GRAD_SKIP_MAX="${GRAD_SKIP_MAX:-100000000000.0}"
GRAD_CLIP_MIN="${GRAD_CLIP_MIN:-0.5}"
GRAD_CLIP_MAX="${GRAD_CLIP_MAX:-0.5}"
...
PER_LOSS_GRAD_PROBE_START_UPDATE_STEP="${PER_LOSS_GRAD_PROBE_START_UPDATE_STEP:-0}"
PER_LOSS_GRAD_PROBE_END_UPDATE_STEP="${PER_LOSS_GRAD_PROBE_END_UPDATE_STEP:-0}"
PER_LOSS_GRAD_PROBE_INTERVAL="${PER_LOSS_GRAD_PROBE_INTERVAL:-0}"
...
write_launcher_script() {
  local script_path="$1"
  {
    ...
    print_export GRADIENT_CHECKPOINTING "$GRADIENT_CHECKPOINTING"
    ...
    print_export LR_DECAY_EPOCHS "$LR_DECAY_EPOCHS"
    ...
    print_export ADAPTIVE_GRAD_CLIP "$ADAPTIVE_GRAD_CLIP"
    print_export GRAD_CLIP_EMA_BETA "$GRAD_CLIP_EMA_BETA"
    print_export GRAD_CLIP_RATIO "$GRAD_CLIP_RATIO"
    print_export GRAD_SKIP_RATIO "$GRAD_SKIP_RATIO"
    print_export GRAD_SKIP_MAX "$GRAD_SKIP_MAX"
    print_export GRAD_CLIP_MIN "$GRAD_CLIP_MIN"
    print_export GRAD_CLIP_MAX "$GRAD_CLIP_MAX"
    print_export GRAD_CLIP_WARMUP_STEPS "$GRAD_CLIP_WARMUP_STEPS"
    print_export GRAD_CLIP_MAX_CONSECUTIVE_SKIPS "$GRAD_CLIP_MAX_CONSECUTIVE_SKIPS"
    ...
    print_export ADAPTIVE_GRAD_CLIP_RESUME_METRICS "$ADAPTIVE_GRAD_CLIP_RESUME_METRICS"
    print_export AMP_DTYPE "$AMP_DTYPE"
    print_export GEP_LOSS "$GEP_LOSS"
    print_export HUBER_DELTA "$HUBER_DELTA"
    ...
    print_export RESUME_START_EPOCH "$RESUME_START_EPOCH"
    print_export RESUME_SKIP_BATCHES "$RESUME_SKIP_BATCHES"
    print_export PER_LOSS_GRAD_PROBE_START_UPDATE_STEP "$PER_LOSS_GRAD_PROBE_START_UPDATE_STEP"
    print_export PER_LOSS_GRAD_PROBE_END_UPDATE_STEP "$PER_LOSS_GRAD_PROBE_END_UPDATE_STEP"
    print_export PER_LOSS_GRAD_PROBE_INTERVAL "$PER_LOSS_GRAD_PROBE_INTERVAL"
    print_export APPEND_OUTPUT_LOGS "$APPEND_OUTPUT_LOGS"
