...
is_allowed_cli_var() {
  case "$1" in
    ...
    GRAD_CLIP_HARD_RAW_NORM_LIMIT|ADAPTIVE_GRAD_CLIP_RESUME_METRICS|AMP_DTYPE|GEP_LOSS|HUBER_DELTA|MAX_TRAIN_STEPS|INIT_MODEL_PATH|\
...
set_default ADAPTIVE_GRAD_CLIP_RESUME_METRICS ""
...
set_default PER_LOSS_GRAD_PROBE_START_UPDATE_STEP 0
set_default PER_LOSS_GRAD_PROBE_END_UPDATE_STEP 0
set_default PER_LOSS_GRAD_PROBE_INTERVAL 0
