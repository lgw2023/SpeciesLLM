...
is_allowed_cli_var() {
  case "$1" in
    ...
    EMB_PATH|MODEL_CONFIG_JSON|GENE_EMBEDDING_MODALITIES|GENE_EMBEDDING_SUFFIX|NNODES|NPROC_PER_NODE|HOSTS|MASTER_ADDR|\
    ...
    GRADIENT_CHECKPOINTING|TRAIN_MVC|RUNTIME_DO_MVC|RUNTIME_EXPLICIT_ZERO_PROB|\
    ...
    GRAD_CLIP_HARD_RAW_NORM_LIMIT|AMP_DTYPE|GEP_LOSS|HUBER_DELTA|\
    GEP_LOSS_WEIGHT|ZERO_PROB_LOSS_WEIGHT|GEPC_LOSS_WEIGHT|GEPC_ZERO_PROB_LOSS_WEIGHT|\
    MAX_TRAIN_STEPS|INIT_MODEL_PATH|\
    ...
    NAN_CHECK_INTERVAL|METRICS_FLUSH_INTERVAL|BATCH_METADATA_LOG_INTERVAL|\
    BATCH_METADATA_TOP_K|MASKED_GEP_STATS_INTERVAL|LOG_LEVEL|LOG_ALL_RANKS|\
    NUM_WORKERS|PREFETCH_FACTOR|PERSISTENT_WORKERS|PIN_MEMORY|\
    TRAIN_SHUFFLE_ROWS|TRAIN_SHUFFLE_SEED|PARQUET_CHUNK_FILES|\
...
set_default TRAIN_MVC true
set_default RUNTIME_DO_MVC ""
set_default RUNTIME_EXPLICIT_ZERO_PROB ""
set_default LEARNING_RATE 0.000001
set_default MIN_LR 0.0000001
set_default DECAY_LR true
set_default WARMUP_ITERS 2000
set_default WARMUP_RATIO 0.10
set_default LR_DECAY_EPOCHS 0
set_default WEIGHT_DECAY 0.1
set_default SAVE_DATA_INTERVAL 5120000
set_default BETA1 0.9
set_default BETA2 0.98
...
# E1 stability defaults: real skip-on-spike fuse (skip raw grad norm > 1e5)
# + un-pinned clip threshold (0.5/0.5 was a no-op under AdamW).
set_default GRAD_SKIP_RATIO 10.0
set_default GRAD_SKIP_MAX 100000.0
set_default GRAD_CLIP_MIN 0.5
set_default GRAD_CLIP_MAX 1000.0
set_default GRAD_CLIP_WARMUP_STEPS 200
set_default GRAD_CLIP_MAX_CONSECUTIVE_SKIPS 50
set_default GRAD_CLIP_EMA_RUNAWAY_FACTOR 2.0
set_default GRAD_CLIP_HARD_RAW_NORM_LIMIT 0.0
# AMP precision (NPU has no usable bf16; default fp32 for stability) + GEP loss.
set_default AMP_DTYPE float32
set_default GEP_LOSS mse
set_default HUBER_DELTA 5.0
set_default GEP_LOSS_WEIGHT 1.0
set_default ZERO_PROB_LOSS_WEIGHT 1.0
set_default GEPC_LOSS_WEIGHT 0.1
set_default GEPC_ZERO_PROB_LOSS_WEIGHT 0.1
set_default MAX_TRAIN_STEPS 0
...
set_default BATCH_METADATA_LOG_INTERVAL "$LOG_INTERVAL"
set_default BATCH_METADATA_TOP_K 16
set_default MASKED_GEP_STATS_INTERVAL 0
...
set_default TRAIN_SHUFFLE_ROWS false
set_default TRAIN_SHUFFLE_SEED 42
set_default PARQUET_CHUNK_FILES 64
